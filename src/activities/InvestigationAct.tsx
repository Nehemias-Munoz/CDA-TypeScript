...
const InvestigationAct = () => {
  ...
  const [activity] = useState({
    ...
    concept: 'Arte',
    instruction: 'Busque 3 definiciones del concepto, citando sus autores.',
  });
          ...
          <Card>
            <ScrollView showsVerticalScrollIndicator={false}>
              ...
              <Card.Image
                ...
                source={require('../assets/activities/investigation.jpg')}
              />
              <Card containerStyle={styles.secondaryCard}>
                ...
                <Card.Image
                  ...
                  source={require('../assets/activities/investigation/arte.jpg')}
                />

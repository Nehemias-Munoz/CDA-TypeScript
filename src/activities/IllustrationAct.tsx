...
const IllustrationAct = () => {
  ...
  const [activity] = useState({
    ...
    title: 'Ilustración',
    type: 'Image',
    description: 'Representa de manera gráfica el siguiente concepto:',
    concept: 'Alegria',
    instruction: 'Cree y suba una ilustración.',
  });
          ...
          <Card>
            <ScrollView showsVerticalScrollIndicator={false}>
              ...
              <Card.Image
                ...
                source={require('../assets/activities/illustration.jpg')}
              />
              <Card containerStyle={styles.secondaryCard}>
                ...
                <Card.Image
                  ...
                  source={require('../assets/activities/illustration/alegria.jpg')}
                />
...
export default IllustrationAct;

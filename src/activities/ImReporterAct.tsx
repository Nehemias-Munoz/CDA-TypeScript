...
const ImReporterAct = () => {
  ...
  const [activity] = useState({
    ...
    title: 'A Entrevistar',
    type: ['Link', 'Audio'],
    description: 'Realice un trabajo periodístico asociado al siguiente tema:',
          ...
          <Card>
            <ScrollView showsVerticalScrollIndicator={false}>
              ...
              <Card.Image
                ...
                source={require('../assets/activities/iamreporter.jpg')}
              />
              <Card containerStyle={styles.secondaryCard}>
                ...
                <Card.Image
                  ...
                  source={require('../assets/activities/imreporter/climaticchange.jpg')}
                />
